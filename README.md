...
```
cd existing_repo
git remote add origin https://gitlab.physik.uni-muenchen.de/LDAP_ls-raedler/cell-viewer.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.physik.uni-muenchen.de/LDAP_ls-raedler/cell-viewer/-/settings/integrations)
